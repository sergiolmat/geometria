...
\renewcommand*{\backrefalt}[4]{
	...
	\fi}%
\titulo{Sistemas de Numeração através da calculadora}
\autor{Cláudio José Mendes \\ Sérgio Luís Soares Almeida}
\local{Brasília}
\data{2018, 13 de Junho}
\instituicao{%
  ...
  \par
 PROFMAT}
\tipotrabalho{Planejamento de Aula}
